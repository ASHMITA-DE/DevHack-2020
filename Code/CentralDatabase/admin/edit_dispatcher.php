...
<?php
  $query=mysqli_query($connect,"select * from dispatcher LEFT JOIN branch ON dispatcher.branchid = branch.branchid where dispatcherid='$ID'")or die(mysqli_error());
$row=mysqli_fetch_array($query);
  ?>
				...
				$result =  mysqli_query($connect,"select * from branch")or die(mysqli_error()); 
...
$result=mysqli_query($connect,"select * from dispatcher") or die (mysqli_error());
...
mysqli_query($connect," UPDATE dispatcher SET branchid='$branchid', firstname='$firstname', lastname='$lastname', username='$username', password='$password', confirm_password='$confirm_password'
 WHERE dispatcherid = '$id' ")or die(mysqli_error());
